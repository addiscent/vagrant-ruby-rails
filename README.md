...
# NOTE: THIS IS A CLONED PROJECT, IN TRANSITION... only the ORIGINAL PROJECT DESCRIBED HEREIN.
## This project has NOT been "RAILified" yet.  DO NOT USE THIS PROJECT UNTIL FURTHER NOTICE.
## You may wish to go here, https://github.com/ckthomaston/vagrant-ruby-git, if you are interested in alpha testing "vagrant-ruby-git" 
